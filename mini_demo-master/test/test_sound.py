...
async def test_play_tts():
    ...
    # is_serial:串行执行
    # text:要合成的文本
    block: StartPlayTTS = StartPlayTTS(text="尊敬的各位领导，下面由我代表数据科学与智能计算科教平台汇报一下当前平台的建设情况。")
...
async def test_play_online_audio():
    ...
    block: PlayAudio = PlayAudio(
        url="https://cv-sycdn.kuwo.cn/8ec4f848a11a60a897582cc5d57b4b7b/66a1a582/resource/n3/1/67/116895295.mp3?bitrate$128&from=vip",
